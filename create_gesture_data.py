    ...
    #Time to configure the hand specifically into the ROI...
        ...
        if hand is not None:
            ...
            if num_imgs_taken <= 600:
                ...
                if num_imgs_taken % 2 == 0:
                    cv2.imwrite(r"gesture/train/" + str(element) + "/" + str(num_imgs_taken) + '.jpg', thresholded)
                else:
                    cv2.imwrite(r"gesture/test/" + str(element) + "/" + str(num_imgs_taken) + '.jpg', thresholded)
            else:
                break
            num_imgs_taken +=1
        else:
